...
import com.yaosiyuan.base.BaseRedisService;
import com.yaosiyuan.base.ResponseBase;
import com.yaosiyuan.constants.Constants;
import com.yaosiyuan.dao.MemberDao;
import com.yaosiyuan.entity.UserEntity;
import com.yaosiyuan.mq.RegisterMailboxProducer;
import com.yaosiyuan.utils.MD5Util;
import com.yaosiyuan.utils.TokenUtils;
...
public class MemberServiceImpl extends BaseApiService implements MemberService {
	...
	public ResponseBase qqLogin(@RequestBody UserEntity user) {
		...
		UserEntity userEntity = (com.yaosiyuan.entity.UserEntity) userToken.getData();
		// 5.修改用户openid
		Integer userId = userEntity.getId();
